...
JSON格式：
{
  "seotitle": "SEO商品標題，格式：品名＋空格＋品牌或作者。辨識優先順序：1.商品標題【】內的品牌名，例如【荷蘭BS】→荷蘭BS、【Pro′sKit 寶工】→Pro′sKit 寶工；2.商品規格欄位的品牌欄；3.書籍的作者姓名；4.以上都找不到則只輸出品名，後面不加任何文字。80字以內，只輸出標題本身不加說明",
