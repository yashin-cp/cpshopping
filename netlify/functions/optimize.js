...
JSON格式：
{
  "seotitle": "SEO商品標題，輸出格式：產品名稱＋空格＋作者或品牌。規則如下：①書籍類（商品規格有「作者」欄位）→從作者欄抓作者姓名放後方，例如：神奇柑仔店番外篇：神祕可疑的天獄園2 廣嶋玲子；②非書籍類→從標題【】或商品規格「品牌」欄辨識品牌名，若品名已含品牌則將品牌從品名中移除後放到後方，例如：【新加坡myFirst】Voice 2 迷你KTV麥克風喇叭→Voice 2 迷你KTV麥克風喇叭 myFirst；若品名不含品牌則直接補到後方，例如：長高高跳繩 荷蘭BS；③找不到品牌或作者→只輸出品名，不補任何推測文字。禁止自行推測或捏造作者與品牌。80字以內，只輸出標題本身",
